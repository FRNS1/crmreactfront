      ...
      {loading === false ? (
        ...
        <Layout>
          ...
          >
            <ContainerHeader>
              <ContentHeader>
                <h2> {data.isCnpj === false ? customerName : customerRazaoSocial} </h2>
                <ActionsHeader>
                  <button 
                    className={`botoes ${muda === 'infPropostas' ? 'botaoAtivo' : ''}`} 
                    onClick={() => Mudapagina("infPropostas")} >
                      Informações 
                  </button>
              ...
              <div>
                {muda === 'infPropostas' && (
                  <FormContent>
                      <form>
                        <FlexGroup>
                          <label htmlFor="totalVaslorDesejado"> 
                            Valor Desejado 
                            <CurrencyInput
                          ...
                          <FlexGroup>
                            <label htmlFor='oservacaocliente'>
                            ...
                            <label htmlFor='observacaoAnalista'>
                          ...
                          <div className='action' onClick={sendInfos}>
                    ...
                    <form>
                      <ContentForm>
                        ...
                        <FlexGroup>
                          ...
                          <label htmlFor="numTitulosProtestados">
                            Quantidade de titulos protestados
                            <input
                        ...
                        <FlexGroup>
                          <label htmlFor="valortitulosprotestados">
                            Valor dos titulos protestados
                            <input
                        ...
                        <FlexGroup>
                          <label htmlFor="numChequesDevolvidos">
                ...
                {muda === 'bacen' && (
                  <ContentTableGroup>
                    <GroupOne>
                      ...
                      <TableContainer sx={{ textAlign: 'center'}}>
                        <Table sx={{borderCollapse: 'collapse'}}>
                          <TableHead>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell 
                                sx={{
                                  textAlign: 'center', 
                                  color: '#081535', 
                              ...
                              <TableCell sx={{textAlign: 'center'}}> 
                                <input
                                  style={{ color: '#081535', fontWeight: 'bold', fontSize: '16px' }}
                          ...
                          <TableBody>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Até 30 dias e vencidos até 14 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> 31 a 60 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                                  name="vencer3160Dias"
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> 61 a 90 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                                  name="vencer6190Dias"
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> 91 a 180 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> 181 a 360 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                                  name="limitesCreditoVencimentoAte360Dias"
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Acima de 360 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                                  name="limitesCreditoVencimentoAte360Dias"
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Indeterminado </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                    ...
                    <GroupOne>
                      ...
                      <TableContainer>
                        <Table>
                          ...
                          <TableBody>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> 15 a 30 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                    ...
                    <GroupOne>
                      ...
                      <TableContainer>
                        <Table>
                          ...
                          <TableBody>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Até 12 meses </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Acima de 12 meses </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                    ...
                    <GroupOne>
                      ...
                      <TableContainer>
                        <Table>
                          ...
                          <TableBody>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Coobrigação Assumida </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Coobrigação Prestadas </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                    ...
                    <GroupOne>
                      <h2>Créditos a Liberar - Total</h2>
                      <Paper sx={{ width: '100%', overflow: 'hidden', marginTop: '20px'}}>
                      <TableContainer>
                        <Table>
                          <TableHead>
                          ...
                          <TableBody>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Créditos a Liberar até 360 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Créditos a Liberar acima de 360 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                    ...
                    <GroupOne>
                      <h2>Limites de Crédito - Total</h2>
                      <Paper sx={{ width: '100%', overflow: 'hidden', marginTop: '20px'}}>
                      <TableContainer>
                        <Table>
                          <TableHead>
                          ...
                          <TableBody>
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Limite de Crédito com vencimento até 360 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                                  name="limitesCreditoVencimentoAte360Dias"
                            ...
                            <TableRow sx={{border: '1px solid rgba(0, 0, 0, 0.2)'}}>
                              <TableCell sx={{textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.2)'}}> Limites de Crédito com vencimento acima de 360 dias </TableCell>
                              <TableCell sx={{textAlign: 'center'}}>
                                <input
                    ...
                    <div className='actionBacen' onClick={sendBacen}>
                      <button className='botaoEnviarObservacoes'>
                        <span className='stringEnviarDados'> Salvar </span>
                      </button>
                    </div>
                  ...
                  <FormContent>
                    <form>
                      <ContentForm>
                        <FormTop>
                          <FlexGroup>
                            <label htmlFor="NumPendenciasFinanceirasAlls">
                              Quantidade de pendências financeiras
                              <input
                            ...
                            <label htmlFor="ValorPendenciasFinanceirasAlls">
                              Valor das pendências financeiras
                              <input
                            ...
                            <label htmlFor="NumRecuperacoesAlls">
                          ...
                          <FlexGroup>
                            <label htmlFor="valorRecuperacoesAlls">
                            ...
                            <label htmlFor="NumChequeSemFundoAlls">
                              Quantidade de cheque sem fundo
                              <input
                            ...
                            <label htmlFor="NumProtestosAlls">
                          ...
                          <FlexGroup>
                            <label htmlFor="valorProtestosAlls">
                              Valor dos protestos
                              <input
                            ...
                            <label htmlFor="limiteSugeridoAlls">
                              Limite Sugerido
                              <input
                            ...
                            <label htmlFor="NumRestricoesAlls">
                          ...
                          <FlexGroup>
                            <label htmlFor="valorRestricoesAlls">
                      ...
                      <div className='action' onClick={sendAllsData}>
                        <button>
                          <span> Salvar </span>
                        </button>
                      </div>
